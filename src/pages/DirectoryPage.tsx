...
export default function DirectoryPage({ businesses, onToggleStar, categories, selectedCategory, onSelectCategory, loading, }: Props) {
  ...
  return (
    <section className="max-w-screen-xl mx-auto py-6 px-4 space-y-6 font-mono">
      ...
      <div className="mb-8">
        ...
        }`}>Discover and connect with businesses in your area</p>
      </div>
        ...
        <table className="w-full text-sm border-collapse font-mono rounded-none table-fixed">
          <thead className={`text-gray-500 text-xs uppercase tracking-widest rounded-none ${
            ...
            <tr className="rounded-none">
              ...
              <th className={`w-32 min-w-32 px-4 py-2 text-left border-b rounded-none ${
                isDarkMode ? 'border-gray-600' : 'border-gray-300'
              }`}>Socials</th>
            </tr>
          </thead>
          <tbody>
            ...
            {!sortedBusinesses.length && (
              <tr>
                <td colSpan={7} className={`text-center py-10 rounded-none ${
